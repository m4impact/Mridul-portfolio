...
const project = {
  ...
  stats: [
    ...
    ["Affiliation", "Independent — not TMF"],
  ...
  body: [
    ...
    "Built independently alongside full-time work at TMF and VCU coursework. All product decisions are made around a single constraint: would someone with no business background and no budget be able to use this and trust the output?",
    "Current status: design and early architecture. Target for first beta: 50 users by December 2026 graduation.",
    "MAT is not affiliated with TMF. TMF is where I work. MAT is what I am building because the problem is real and nobody else is building the right version of it.",
  ],
