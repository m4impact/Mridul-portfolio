...
// UPES Chapter — scroll reveal, no click
      ...
      <div className={`upes-body${open ? " open" : ""}`}>
        <div className="upes-inner">
          ...
          <div className="upes-narrative">
            ...
            <p>The MBA wasn't a credential play. It was a <strong>deliberate repair job.</strong> At UPES I learned how businesses are actually structured — how strategy flows through process, how decisions get made inside organisations. I came in curious and undirected. I left knowing how to channel it.</p>
          ...
          <div className="upes-pillars reveal">
            <div className="upes-pillar">
              ...
              <span className="pillar-body">Point guard. School of Business representative. Led the team to victory — coached from the bench when subbed out. Won when it mattered.</span>
            </div>
            <div className="upes-pillar">
              <span className="pillar-label">In the room</span>
              <span className="pillar-value">2 sponsors<br />closed</span>
              <span className="pillar-body">First event after joining GEMS Marketing Club. Walked in as Sponsorship & PR. Walked out with two vendors committed. No university name doing the work. Just the pitch.</span>
            </div>
            <div className="upes-pillar">
              <span className="pillar-label">At the desk</span>
              <span className="pillar-value">3.4<br />GPA</span>
              <span className="pillar-body">Consistent across strategy, research methods, operations. Treated every project as a real brief — not an assignment.</span>
            </div>
          </div>
          <div className="photo-pair reveal">
            <div><img src="/upes-game-2.jpg" alt="Mridul defending — UPES Trident Titans basketball" /><div className="photo-caption"><div className="photo-caption-label">University Games · Defense</div><div className="photo-caption-sub">Reading the game before the play develops</div></div></div>
          ...
          <div className="photo-triple reveal" style={{marginTop:"4px"}}>
            ...
            <div><img src="/upes-letter.jpg" alt="BUZZ Society appointment letter" /><div className="photo-caption"><div className="photo-caption-label">BUZZ Society · Core Member</div><div className="photo-caption-sub">Appointment — School of Business, UPES</div></div></div>
          </div>
          <div className="upes-cert reveal">
            <div>
              ...
              <p className="cert-body-desc">Before the official Union Budget was announced, teams were given the same data the government had and asked to formulate India's national budget. We came second — close enough to matter, far enough to still be thinking about what we'd change.</p>
              <span className="cert-result">// Runner-up · National Budget Formulation Competition · UPES 2025</span>
            </div>
            <img src="/upes-cert.jpg" alt="Certificate — Budget Formulation Tournament, UPES" />
          </div>
  ...
  return (
    <section id="about" aria-label="About">
      ...
      <div className="about-body">
        ...
        <p className="reveal d1">I'm a <strong>Master's student in Decision Analytics</strong> at Virginia Commonwealth University, concentrating in marketing. Real businesses, real data, real decisions.</p>
        <p className="reveal d2">On the side, I'm building <strong>MAT</strong> — a market intelligence platform for first-time founders who can't afford to get the analysis wrong. Free. Plain language. Built because the need is real.</p>
        <p className="reveal d3">In <strong>May 2026</strong>, I join <strong>TMF (Richmond)</strong> as a Product Manager. TMF is where I'm going. MAT is what I'm building because the workday ends and the need doesn't.</p>
        ...
        <div className="about-extended">
          ...
          <p className="reveal d1" style={{fontSize:"1.25rem",fontWeight:400,lineHeight:1.85,color:"rgba(10,10,8,.75)",marginBottom:"2rem",maxWidth:"580px"}}>A local news channel covered the Hoops Fest twice — before the event and on the day. That doesn't happen unless something real is being built.</p>
          <div className="press-grid">
            <div className="press-card reveal">
              <div className="press-video"><iframe src="https://www.youtube.com/embed/NaBxIBpsMDE" title="Uttarakhand Hoops Fest — pre-event press conference" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen loading="lazy" /></div>
            ...
            <div className="press-card reveal d1">
              <div className="press-video"><iframe src="https://www.youtube.com/embed/UuKnFZZl_vs?start=170" title="Uttarakhand Hoops Fest — event day coverage" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen loading="lazy" /></div>
          ...
          <div className="project-body">
            ...
            {p.hasPhotos && (
              <div style={{marginTop:"1.5rem"}}>
                <div className="hoops-hero"><img src="/hoops-champions.jpg" alt="Uttarakhand Hoops Fest champions — Kashipur March 2024" /><div className="photo-overlay"><div className="photo-overlay-label">Kashipur · March 2024</div><div className="photo-overlay-sub">Champions receive ₹51,000 prize</div></div></div>
                <div className="hoops-pair">
                  <div><img src="/hoops-ceremony.jpg" alt="Opening ceremony — Uttarakhand Hoops Fest" /><div className="photo-overlay"><div className="photo-overlay-label">Opening Ceremony</div></div></div>
                  <div><img src="/hoops-opening.jpg" alt="Lamp lighting — Uttarakhand Hoops Fest" /><div className="photo-overlay"><div className="photo-overlay-label">Inauguration · Lamp Lighting</div></div></div>
                </div>
              </div>
            )}
          </div>
      ...
      <div className="skills-list">
        {skills.map(({name,pct,pills},i) => (
          <div key={i} className="skill-row reveal">
            ...
            <div className="skill-bar" role="progressbar" aria-valuenow={pct} aria-valuemin={0} aria-valuemax={100} aria-label={`${name} ${pct}%`}><div className="skill-fill" data-width={`${pct}%`} /></div>
  ...
  return (
    <section id="services" aria-label="Services">
      ...
      <div className="reveal d1" style={{maxWidth:620,marginBottom:"3.5rem"}}>
        <p style={{fontFamily:"var(--font-serif)",fontStyle:"italic",fontWeight:300,fontSize:"clamp(1.2rem,2.2vw,1.8rem)",color:"var(--ink)",lineHeight:1.45,marginBottom:"1.2rem"}}>It's not always about the money.</p>
  ...
  return (
    <section id="contact" aria-label="Contact">
      <div>
        ...
        <p className="contact-sub reveal d1">If you're building something, need analysis done, or just want to talk strategy — I'm around.</p>
      ...
      <div className="reveal d1">
        {sent ? (
          <div className="form-success" role="status"><div className="success-tick">✓</div><div className="success-msg">Message sent. I'll be in touch shortly.</div></div>
        ) : (
